...
namespace Game.Store
{
	public class Questions
	{
		...
		{
			int randQuestionNum = this.rnd.Next(this.data.Length);
		...
		private IQuestion[] data = new IQuestion[] {
			...
			new OneVariant(new String[] {
				...
				"Угадай, {name} любит яркий макияж?",
			}),
			new OneVariant(new String[] {
				"Угадай, {name} ведёт здоровый образ жизни?",
			...
			new OneVariant(new String[] {
				...
				"Как думаешь, {name} любит принимать ванну с пеной?",
			}),
			new OneVariant(new String[] {
				"Любишь книги и фильмы про вампиров?",
				"Как считаешь, {name} любит книги и фильмы про вампиров?",
			}),
			new OneVariant(new String[] {
				"Как считаешь, {name} может постоять за любимую девушку?",
				"Ты можешь постоять за любимую девушку?",
			}),
			new OneVariant(new String[] {
				"Как думаешь, {name} может подтянуться на турнике 30 раз?",
				"Ты можешь подтянуться на турнике 30 раз?",
			}),
			new OneVariant(new String[] {
				"Как думаешь, {name} служил в армии?",
				"Ты служил в армии?",
			}),
			new OneVariant(new String[] {
				"Ты можешь потратить все деньги на новые туфли?",
				"Как думаешь, {name} может потратить все деньги на новые туфли?",
			}),
			new OneVariant(new String[] {
				"Для тебя «красиво» важнее, чем «удобно»?",
				"Думаешь, {name} предпочитает красоту удобству?",
			}),
			new OneVariant(new String[] {
				"Как думаешь, {name} может починить протекающий кран?",
				"Ты можешь починить протекающий кран?",
			}),
			new OneVariant(new String[] {
				"Ты печёшь пироги и торты?",
				"Думаешь, {name} печёт пироги и торты?",
			}),
			new OneVariant(new String[] {
			...
			new OneVariant(new String[] {
				...
				"Думаешь, {name} умеет варить борщ?",
			}),
			new TwoVariants(new String[2][] {
				new String[] {
			...
			new OneVariant(new String[] {
				...
				"Как ты думаешь, {name} чересчур впечатлительная?",
			}),
			new OneVariant(new String[] {
			...
			new OneVariant(new String[] {
				...
				"Угадай, {name} часто плачет по пустякам?",
			}),
			new OneVariant(new String[] {
				"Как ты думаешь, {name} обидчивый?",
				"Ты обидчив?",
			}),
			new OneVariant(new String[] {
			...
			new OneVariant(new String[] {
				"Угадай, {name} умеет рассказывать анекдоты и смешные истории?",
			...
			new OneVariant(new String[] {
				...
				"Думаешь, {name} часто испытывает перепады настроения?",
			}),
			new OneVariant(new String[] {
			...
			new OneVariant(new String[] {
				"Думаешь, {name} считает всех блондинок глупыми?",
				"Ты считаешь блондинок глупыми?",
			}),
			new OneVariant(new String[] {
				"Ты много времени уделяешь своей внешности?",
				"Думаешь, {name} много времени уделяет своей внешности?",
			}),
			new OneVariant(new String[] {
				"Тебя можно назвать феминисткой?",
				"По-твоему, {name} - феминистка?",
			}),
			new OneVariant(new String[] {
				"Думаешь, {name} считает женскую логику абсурдной?",
				"Ты считаешь женскую логику абсурдной?",
			}),
			new OneVariant(new String[] {
				"Думаешь, {name} больше говорит, чем делает?",
				"Можно ли сказать, что ты больше говоришь, чем делаешь?",
			}),
			new OneVariant(new String[] {
				"Тебя можно назвать болтушкой?",
				"Думаешь, {name} болтушка?",
			}),
			new OneVariant(new String[] {
			...
			new OneVariant(new String[] {
				...
				"Угадай, {name} хочет себе парня со спортивным телосложением?",
			}),
			new TwoVariants(new String[2][] {
				new String[] {
			...
			new OneVariant(new String[] {
				...
				"Угадай, {name} может сама предложить парню свидание?",
			}),
			new OneVariant(new String[] {
			...
			new OneVariant(new String[] {
				...
				"Угадай, {name} верит в принца на белом коне?",
			}),
			new OneVariant(new String[] {
				"Ты хочешь, чтобы любимый приносил завтрак в постель?",
				"Угадай, {name} хочет завтрак в постель от любимого?",
			}),
			new OneVariant(new String[] {
			...
			new OneVariant(new String[] {
				"Угадай, {name} плакал хоть раз после разрыва отношений?",
			...
			new OneVariant(new String[] {
				"Как ты думаешь, {name} считает, что ложь во имя добра - это правильное решение?",
			...
			new OneVariant(new String[] {
				...
				"Думаешь, {name} хотела бы стать любимой девушкой супергероя?",
			}),
			new OneVariant(new String[] {
				"Ты хотела бы, чтобы {name} тебя спас?",
				"Думаешь, {name} хотела бы, чтобы ты её спас?",
			}),
			new OneVariant(new String[] {
				"Для тебя приемлем секс на первом свидании?",
				"Как считаешь, {name} готова заняться сексом на первом свидании?",
			}),
			new OneVariant(new String[] {
				"Как ты думаешь, {name} - однолюб?",
				"Ты однолюб?",
			}),
			new OneVariant(new String[] {
				"Ты можешь любить двух мужчин одновременно?",
				"Думаешь, {name} может любить двух мужчин одновременно?",
			}),
			new OneVariant(new String[] {
				"Думаешь, {name} всегда сдерживает обещания?",
				"Ты всегда держишь обещания?",
			}),
			new OneVariant(new String[] {
				"Ты часто опаздываешь на свидания?",
				"Думаешь, {name} часто опаздывает на свидания?",
			}),
			new OneVariant(new String[] {
				"Ты мечтаешь об истории любви, как в фильмах?",
				"Думаешь, {name} мечтает об истории любви, как в фильмах?",
			}),
			new OneVariant(new String[] {
				"Думаешь, {name} смог бы встречаться с девушкой, которая умнее его?",
			...
			new OneVariant(new String[] {
				"Думаешь, {name} боится женских слёз?",
				"Ты боишься женских слёз?",
			}),
			new OneVariant(new String[] {
				"Ты могла бы выйти замуж по рассчёту?",
				"Думаешь, {name} могла бы выйти замуж по рассчёту?",
			}),
			new OneVariant(new String[] {
